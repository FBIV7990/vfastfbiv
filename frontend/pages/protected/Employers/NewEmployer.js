...
class NewEmployer extends React.Component {
  ...
  onSubmit() {
    ...
    const {mobile,email,first_name,last_name,gstCertificate,company,
      ...
      shippingLandline,shippingFaxstd,shippingFax,website,gstin,pan,cin,country_code,username,company_name} = this.state;
console.log('logging nweVendor:',this.state);
  ...
  formdata.append('cin_number',cin);
      ...
      dispatch(employerActions.create(formdata));}
    // }
...
const connectedNewEmployer = connect(mapStateToProps)(NewEmployer);
export default connectedNewEmployer;
